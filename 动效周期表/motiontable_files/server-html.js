;(function(window, document, undefined){
    ...
    /* settings ------------------------------------------------------------ */
    var ASSET_DIR = 'https://web.archive.org/web/20190719163403/https://ad.xdomain.ne.jp/img/';
    var BANNER_LIST_FOR_ANDROID = [
        {
            img: ASSET_DIR + 'cocorosekai.gif',
            url: 'https://web.archive.org/web/20190719163403/https://ad.xdomain.ne.jp/rd.php?aid=xdomain_cocorosekai_a'
        }
    ];
    var BANNER_LIST_FOR_OTHER = [
        {
            img: ASSET_DIR + 'cocorosekai.gif',
            url: 'https://web.archive.org/web/20190719163403/https://ad.xdomain.ne.jp/rd.php?aid=xdomain_cocorosekai_i'
        }
    ];
    /* --------------------------------------------------------------------- */
...
/*
     FILE ARCHIVED ON 16:34:03 Jul 19, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 02:44:45 Mar 18, 2020.
...
playback timings (ms):
  ...
  PetaboxLoader3.resolve: 93.188 (2)
  load_resource: 967.125
  captures_list: 51.987
  LoadShardBlock: 35.509 (3)
  CDXLines.iter: 11.447 (3)
  PetaboxLoader3.datanode: 241.461 (5)
  RedisCDXSource: 1.332
  esindex: 0.016
